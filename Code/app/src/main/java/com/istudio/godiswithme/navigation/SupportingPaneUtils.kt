...
val godImages = listOf(
    ...
    GodImage(
        title = "Saraswati",
        res = R.drawable.cover_saraswati,
    ...
    GodImage(
        title = "Srinivasa",
        res = R.drawable.cover_srinivasa,
    ...
    GodImage(
        title = "Narasimha",
        res = R.drawable.cover_narasimha,
